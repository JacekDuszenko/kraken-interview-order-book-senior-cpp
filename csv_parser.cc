...
std::optional<kraken::OrderSide> OrderSideFromString(const std::string& orderStr) {
  static std::unordered_map<std::string, kraken::OrderSide> const
      table = {{"B", kraken::OrderSide::BID}, {"S", kraken::OrderSide::ASK}};
